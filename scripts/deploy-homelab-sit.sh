...
STOCKTRACKER_MARKETDATA_PROVIDER="${STOCKTRACKER_MARKETDATA_PROVIDER:-stub}"
STOCKTRACKER_FX_PROVIDER="${STOCKTRACKER_FX_PROVIDER:-stub}"
DRY_RUN="false"
VALIDATE_ONLY="false"
...
STOCKTRACKER_MARKETDATA_PROVIDER=${STOCKTRACKER_MARKETDATA_PROVIDER}
STOCKTRACKER_FX_PROVIDER=${STOCKTRACKER_FX_PROVIDER}
...
main() {
  ...
  log "Effective config: profile=${QUARKUS_PROFILE} app_host=${APP_HOST} db_host=${DB_HOST} db_port=${DB_PORT} db_name=${DB_NAME} public_base_url=${PUBLIC_BASE_URL} marketdata_provider=${STOCKTRACKER_MARKETDATA_PROVIDER} fx_provider=${STOCKTRACKER_FX_PROVIDER}"
